...
class RBTreeDefDumper : public IRBTreeDumper<Element, Compar> {
public:
...
public:
    void rbTreeEvent(typename IRBTreeDumper<Element, Compar>::RBTreeDumperEvent ev,
                     ...
                     typename IRBTreeDumper<Element, Compar>::TTreeNode* nd) override
    {
        ...
        char fnBuf[255];
        sprintf(fnBuf, "%s\\dump_#_%04d.gv", _imgPath.c_str(), _imgCounter);
